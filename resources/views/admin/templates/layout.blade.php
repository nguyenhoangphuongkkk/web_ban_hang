...
<head>
    ...
    <!-- chartist CSS -->
    <link rel="stylesheet" href="{{ asset('asset/plugins/c3-master/c3.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/css/style.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/plugins/chartist-js/dist/chartist.min.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/plugins/chartist-js/dist/chartist-init.css') }}">
    <link rel="stylesheet" href="{{ asset('asset/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css') }}">
</head>
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand ms-4" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('asset/images/logo-light-icon.png') }}" alt="homepage" class="dark-logo" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{ asset('asset/images/logo-light-text.png') }}" alt="homepage" class="dark-logo" />
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('route_index_category') }}" aria-expanded="false"><i class="mdi me-2 mdi-table"></i><span
                                    class="hide-menu">Category</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('product_index') }}" aria-expanded="false"><i
                                    class="mdi me-2 mdi-emoticon"></i><span class="hide-menu">Product</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('user') }}" aria-expanded="false"><i class="mdi me-2 mdi-earth"></i><span
                                    class="hide-menu">User</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('promotion') }}" aria-expanded="false"><i
                                    class="mdi me-2 mdi-book-open-variant"></i><span class="hide-menu">Promotion</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
...
{{-- content chính --}}
    ...
    <script src="{{ asset('asset/plugins/d3/d3.min.js') }}"></script>
    <script src="{{ asset('asset/plugins/c3-master/c3.min.js') }}"></script>
